...
from modeling_esm import FAEsmForMaskedLM
...
def main(args: DictConfig):
    ...
    config = AutoConfig.from_pretrained(args.model_name, torch_dtype=torch.bfloat16, trust_remote_code=True)
    ...
    # Disable this if using FA2 / packing, since it doesnt' seem to work currently.
