...
class InMemoryPerTokenValueDataset(Dataset):
    ...
    def __init__(
        ...
        self.label_padding_value = MLM_LOSS_IGNORE_INDEX
    ...
    def _tokenize_labels(self, labels_sequence: str) -> Tensor:
        ...
        # cls_eos = torch.full((1, self.label_tokenizer.vocab_size), self.label_padding_value, dtype=tokenized_labels.dtype)
